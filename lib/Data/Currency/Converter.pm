package Data::Currency::Converter;
use warnings;
use strict;
...
Data::Currency::Converter - Moose Role for Data::Currency Converters

=head1 DESCRIPTION

This simple module provides a base for building currency conversion backends
for Data::Currency.  You can use this module either as a basis for understanding
...
=head1 SYNOPSIS
    ...
    sub convert {
        my ($self, $currency, $code) = @_;

        # convert $currency->value to $code and return a new currency object
    }
...
2 arguments: an isntance of L<Data::Currency> and a 3-character currency code.
